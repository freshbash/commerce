    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('ANTIQUES', 'Antiques'), ('AUTOMOBILES', 'Automobiles'), ('BOOKS', 'Books/Textbooks'), ('ELECTRONICS', 'Electronics'), ('FASHION', 'Fashion'), ('TOYS', 'Toys'), ('HOME', 'Home/Kitchen')], default='', max_length=64)),
